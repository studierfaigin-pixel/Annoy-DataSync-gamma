...
<p align="center">
    📑 <a href="https://huggingface.co/papers/xxxx.xxxxx" target="_blank">Paper</a> &nbsp&nbsp | &nbsp&nbsp 🌐 <a href="https://specx.github.io/" target="_blank">Project Page</a> &nbsp&nbsp | &nbsp&nbsp 🤗 <a href="https://huggingface.co/collections/WinderBYZ/specx-67a978e28fd926b56a4f55a2" target="_blank">Released Resources</a> &nbsp&nbsp | &nbsp&nbsp 💾 <a href="https://huggingface.co/datasets/WinderBYZ/Annoy-PyEdu-Rs-gamma" target="_blank">Dataset</a> &nbsp&nbsp | &nbsp&nbsp 📦 <a href="https://github.com/studierfaigin-pixel/Annoy-DataSync" target="_blank">Repo</a>  
<br>
...
|Dataset|Link|
|-|-|
|Annoy-PythonEdu-Rs|[🤗](https://huggingface.co/datasets/WinderBYZ/Annoy-PyEdu-Rs-gamma)|
|Annoy-PythonEdu-Rs-Raw|[🤗](https://huggingface.co/datasets/WinderBYZ/Annoy-PyEdu-Rs-Raw-gamma)|
...
We provide a complete guide for you to build data for Annoy on a toy dataset. After all these steps you can get a dataset with the same format as in our [huggingface dataset](https://huggingface.co/datasets/WinderBYZ/Annoy-PyEdu-Rs-gamma).
...
```
By doing so, you can get data `data/spec_demo_final.jsonl` with the same format as in our [huggingface dataset](https://huggingface.co/datasets/WinderBYZ/Annoy-PyEdu-Rs-gamma).
